                ...
                <table class="table mt-2">
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['cari']) && $_GET['cari'] != null) {
                            $cari = $_GET['cari'];
                            $sql_cari = "SELECT * FROM `usertrx` INNER JOIN `user` on user.id = usertrx.userid WHERE `username` like $cari limit $halaman_awal, $batas";
                            $data_user = $conn->query($sql_cari);

                            $sql_cari2 = "SELECT * FROM `usertrx` INNER JOIN `user` on user.id = usertrx.userid WHERE `username` like $cari limit $halaman_awal, $batas";
